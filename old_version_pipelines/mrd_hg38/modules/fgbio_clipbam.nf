process FGBIO_CLIPBAM {
    ...
    output:
    tuple val(sampleid), path("*.consensus.mapped.filtered.clipped.bam"), emit: bam
    ...
    script:
    def args = task.ext.args ?: '--clip-overlapping-reads=true'
    ...
    fgbio \\
        ...
        $args \\
        --ref $fasta \\
        --output ${prefix}.consensus.mapped.filtered.clipped.bam
